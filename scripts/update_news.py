...
NOISE_PATTERNS = [
    ...
    re.compile(r'\b股票\b|\b股价\b|\b涨跌\b|\b上市\b|\bIPO\b|\b涨停\b|\b跌停\b|\b开盘\b|\b收盘\b', re.I),
    re.compile(r'概念股|无人机概念股|机器人概念股', re.I),
    re.compile(r'\b评级\b|\b买入\b|\b卖出\b|\b增持\b|\b目标价\b|\b市盈率\b|\b市净率\b', re.I),
